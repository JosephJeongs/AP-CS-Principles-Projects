...
class Button(pygame.sprite.Sprite):
    def __init__(self,x):
        ...
        self.index = 0
        self.x = x
        self.buttons = ["AP CS Project/button.png","AP CS Project/button_hit.png"]
...
class Notes(pygame.sprite.Sprite):
    def __init__(self,column,y):
        ...
        self.note = "AP CS Project/circle.png" # white circle: https://www.pinterest.com/pin/download-white-circle-png--658510776779891347/ (ALL OTHER IMAGES USED IN THIS PROGRAM WERE MADE IN MS PAINT)
...
class Longnote(pygame.sprite.Sprite):
    def __init__(self,column,y,):
        ...
        self.longnote = "AP CS Project/long_note.png" 
...
class Health(pygame.sprite.Sprite):
    def __init__(self):
        self.health = "AP CS Project/rhythmhealth.png"
